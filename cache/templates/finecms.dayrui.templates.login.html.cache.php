...
<div class="content">
	...
	<form class="login-form" action="" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				<label style="margin-bottom:0"><input class="form-control placeholder-no-fix" type="text" autocomplete="off"  name="code" style="width:150px;" placeholder="<?php echo fc_lang('验证码'); ?>" /></label>
