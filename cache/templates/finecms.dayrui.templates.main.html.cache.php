        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green-sharp  "><?php echo fc_lang('官方'); ?></span>
                </div>
            </div>
            <div class="portlet-body">
                <div>
                    <table class="table table-light mtable">
                        <tr>
                            <td width="160" class="mleft" align="right"><?php echo fc_lang('软件作者'); ?>：</td>
                        ...
                        <tr>
                            ...
                            <td><a href="http://help.finecms.net" target="_blank">help.finecms.net</a> </td>
                        </tr>
                        <tr>
